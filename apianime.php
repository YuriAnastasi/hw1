...
<head>
    ...
    <script src="apianime.js" defer></script>
</head>
...
<body>
    ...
    <section id="container-searchanime">
        <div class="searchanimetitle">
            <div class="searchintro"><strong>Cerca le informazioni sul tuo anime preferito!</strong></div>
        </div>
